<div class="modal mbr-popup cid-sIYpYiiWdO fade" tabindex="-1" role="dialog" data-overlay-color="#000000"
            ...
            <div class="modal-body">
                ...
                <div>
                    <div class="form-wrapper">
                        <!--Formbuilder Form-->
                        <form action="{{ route('user.store') }}" method="POST" class="mbr-form form-with-styler"
