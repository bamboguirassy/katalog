...
<section data-bs-version="5.1" class="article1 cid-sIqERhONdL" id="content01-13">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <p class="mbr-text align-left mbr-fonts-style display-5">Ajoutez rapidement en produit à votre catalogue
                    ...
                    <div class="dragArea form-row">
                        ...
                        <div data-for="nom" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <label for="nom-formbuilder-14" class="form-control-label mbr-fonts-style display-7">Nom
                                produit</label>
                            <input value="{{ old('nom') ?? $produit->nom }}" type="text" name="nom" placeholder="Nom du produit" data-form-field="nom"
                        ...
                        <div data-for="prixUnitaire" class="col form-group">
                            ...
                            <input value="{{ old('prixUnitaire') ?? $produit->prixUnitaire }}" type="number" name="prixUnitaire" placeholder="Prix Unitaire"
                        ...
                        <div data-for="quantite" class="col form-group">
                            ...
                            <input value="{{ old('quantite') ?? $produit->quantite }}" type="number" name="quantite" placeholder="Quantité en stock"
                        ...
                        <div class="col">
                            <button type="submit" class="btn btn-danger display-7"><span
                                    class="mobi-mbri mobi-mbri-plus mbr-iconfont mbr-iconfont-btn"></span>Mettre à jour</button>
                        </div>
                    </div>
                </form>
                <!--Formbuilder Form-->
